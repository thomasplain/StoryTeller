...
c = {}
c[1] = "It starts crying"
c[2] = "It attacks you!"
c[3] = "It starts undressing"
c[4] = "You feel weird about it..."
c[5] = "You start crying"

local function onSceneTouch( self, event )
	if event.phase == "began" then
		
		storyboard.gotoScene( "scene1", "slideUp", 1000  )
...
function scene:createScene( event )
	...
	text1 = display.newText( c[rand3], 0, 0, native.systemFontBold, 24 )
